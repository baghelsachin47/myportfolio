...
const experiences: Experience[] = [
  {
    ...
    • Worked with the team to create an innovative solution using Power Apps and Power Automate.
    • Created Python tools to automate tasks and enhance team productivity.
